...
public class PlayerInstance extends ListenerAdapter {
  ...
  public PlayerInstance(PlayerController playerController) {
    ...
    YoutubeAudioSourceManager youtube =
        new YoutubeAudioSourceManager(true, new MWeb(), new AndroidMusic(), new WebEmbedded());
    ...
    playerManager.loadItem(
        ...
        new AudioLoadResultHandler() {
          ...
          public void playlistLoaded(AudioPlaylist audioPlaylist) {
            playerController
                .getListeners()
                .forEach(l -> l.onPlaylistLoaded(audioPlaylist, getPlayer()));
          }
  ...
  public void playQueue() {
    ...
    isPlaying = true;
    log.info("Now playing: {} (by {})", track.getInfo().title, track.getInfo().author);
    ...
    switch (localPlayerMode) {
      ...
      case NOTHING -> {
        ...
        if (currentIndex < tracks.size()) {
          ...
          isPlaying = false;
          log.info("Queue finished. Not repeating.");
